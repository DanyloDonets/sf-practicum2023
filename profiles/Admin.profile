...
<Profile xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <classAccesses>
        <apexClass>FromGoodsToDonationTest</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
        <apexClass>FromMovingToTotal</apexClass>
        <enabled>true</enabled>
    </classAccesses>
    <classAccesses>
    ...
    <fieldPermissions>
        <editable>true</editable>
        <field>StorageItems__c.Product__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>StorageItems__c.Quantity__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
        <field>StorageItems__c.Storage__c</field>
        <readable>true</readable>
    </fieldPermissions>
    <fieldPermissions>
        <editable>true</editable>
    ...
    <flowAccesses>
        ...
        <flow>FromDonationToStash</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>GoodsFromDonation</flow>
    </flowAccesses>
    <flowAccesses>
        <enabled>false</enabled>
        <flow>StorageConditions</flow>
    </flowAccesses>
    <layoutAssignments>
    ...
    <layoutAssignments>
        <layout>Goods_moving__c-Sending</layout>
        <recordType>Goods_moving__c.Sending</recordType>
    </layoutAssignments>
    <layoutAssignments>
        <layout>Goods_moving__c-Transfer</layout>
    ...
    <layoutAssignments>
        <layout>StorageItems__c-StorageItems Layout</layout>
    </layoutAssignments>
    <layoutAssignments>
